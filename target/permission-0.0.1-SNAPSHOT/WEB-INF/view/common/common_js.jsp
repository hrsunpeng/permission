...
<script src="${baseurl}assets/js/jquery-confirm.min.js"></script>  
...
<script src="${baseurl}assets/js/bootstrap-table.js"></script>
<script src="${baseurl}assets/js/bootstrapSwitch.js"></script>
<script src="${baseurl}assets/js/bootstrap-table-zh-CN.js"></script>
<script src="${baseurl}assets/layer-v1.9.2/layer/layer.js"></script> 
