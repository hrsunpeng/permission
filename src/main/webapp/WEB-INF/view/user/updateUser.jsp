...
<script type="text/javascript" src="${baseurl}js/user/updateUser.js"></script>
</head> 
<body>
		...
		<form id="form" name="form" class="form-horizontal" method="post">
			...
			<div class="panel-body">
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<input type="text" class="form-control checkacc"   
							placeholder="请输入账号" name="usercode" id="usercode" value="${user.usercode}" readonly="readonly" >
					</div>
				</div>
				<div class="line line-dashed line-lg pull-in"></div>
				<div class="form-group">
				...
				<div class="form-group" id="locked">
					...
					<div class="radio">
						<label>
							<input name="form-field-radio" type="radio" class="ace"   value="0"   <c:if test="${user.locked==0}" >checked="checked"</c:if> />
							<span class="lbl">&nbsp;&nbsp;未锁定</span>
						</label>
					</div>
					<div class="radio">
						<label>
							<input name="form-field-radio" type="radio" class="ace" value="1" <c:if test="${user.locked==1}" >checked="checked"</c:if>  />
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<input type="text" class="form-control" placeholder="请输入账号描述"
							name="description" id="description" value="${user.description}">
					</div>
				</div>
			</div>
